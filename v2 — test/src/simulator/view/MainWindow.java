...
import simulator.view.tables.GreenRoadsTableModel;
...
public class MainWindow extends JFrame {
	...
	private void initGUI(String file) {
		...
		// GreenRoads table
		JPanel greenRoadsView = createViewPanel(new JTable(new GreenRoadsTableModel(_ctrl)), "Junctions");
		eventsView.setPreferredSize(new Dimension(500, 200));
		tablesPanel.add(greenRoadsView);
